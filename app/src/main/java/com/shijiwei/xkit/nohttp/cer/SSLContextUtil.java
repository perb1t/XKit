 ...
 */
package com.shijiwei.xkit.nohttp.cer;
...
public class SSLContextUtil {
    ...
    public static SSLContext getSSLContext() {
        ...
        try {
            ...
            //证书需要Base64 编码X.509(.CER)
            String cerFileName;
            cerFileName = "service.gogen.cn.cer";
            InputStream inputStream = XKitApplication.getApplication().getAssets().open(cerFileName);
    ...
    public static final HostnameVerifier HOSTNAME_VERIFIER = new HostnameVerifier() {
        public boolean verify(String hostname, SSLSession session) {
            return true;//信任所有域名
//            return LocalSingleton.SERVER_ROOT.contains(hostname);//信任指定域名
        }
    };
     ...
     * 信任所有域名
     */
    public static final HostnameVerifier HOSTNAME_VERIFIER_ALLOW_ALL = new HostnameVerifier() {
        public boolean verify(String hostname, SSLSession session) {
            return true;
        }
    };
